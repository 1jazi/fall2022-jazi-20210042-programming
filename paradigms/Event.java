...
public class Event {
	public static void main(String[] args) {
		...
		ImageIcon image = new ImageIcon("C:\\Users\\DELL\\OneDrive - AL-Hussien bin Abdullah Technical University\\onedrive_htu\\OneDrive - AL-Hussien bin Abdullah Technical University\\Desktop\\loggo\\htu.png");
		...
		button.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if (e.getSource() == button) {
					if (text.getText().equals("20210042")&&text2.getText().equals("1234")&&text3.getText().equals("jazi")) {
						String name = JOptionPane.showInputDialog("enter how much hours you need ");
					int	y = Integer.parseInt(name);
					y =( y * 75)+300;
						   JOptionPane.showInputDialog(null," you should pay >  "+y);
		...
		label.setText("first name:       password:                Id:  ");
